...
# def squeezenet(input_shape=(96,96,1), num_classes=18, base_squ_filt=32, base_exp_filt=64): # base_squ_filt 16, 32
def squeezenet(input_shape=[96,96,1], num_classes=18, base_squ_filt=32, base_exp_filt=64):
